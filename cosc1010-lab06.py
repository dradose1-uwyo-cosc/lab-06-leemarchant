...
for letter in sorted(random_string):
    if letter in letters_occurrence:
        letters_occurrence[letter] += 1
    else:
        letters_occurrence[letter] = 1

print(f'Occurence of letters:')
for key, value in letters_occurrence.items():
    print(f'{key}: {value}')
...
for letter, occurrence in letters_occurrence.items():
    if occurrence == max(letters_occurrence.values()):
        most_occurred = letter
    elif occurrence == min(letters_occurrence.values()):
...
for letter, occurrence in letters_occurrence.items():
    letters_percentage[letter] = (occurrence/2500)*100

print(f'Percentage of letter occurrence:')
for key, value in letters_percentage.items():
    print(f'{key}: {value}')